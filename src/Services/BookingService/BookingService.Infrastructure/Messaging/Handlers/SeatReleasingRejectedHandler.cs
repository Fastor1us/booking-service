...
public class SeatReleasingRejectedHandler(AppDbContext context) : IMessageHandler
{
        ...
        CancellationToken ct)
    {
        ...
        context.InboxMessages.Add(new InboxMessage()
        {
            ...
            MessageType = Events.SeatReleasingRejected,
            Payload = payload,
            ReceivedAt = DateTime.UtcNow,
        });

        var cmd = GetCommand<SeatReleasingRejected>(payload);
